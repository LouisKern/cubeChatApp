export default {
	...
	messages: [{
		...
		id: 'm4',
		content: 'Good as well, preparing for class now.',
		...
		id: 'm7',
		content: 'Computer science is really interesting. Cannot wait to go through all the material.',
